...
(function() {
    ...
    AForm.registerControl(AFORM_OBJ_PLUGIN, {
        ...
        render: function(nameOrIndex, input, fieldConfig, renderCount, afObj, jpath) {
            ...
            if (fieldConfig.height) {
                cssText += ";height:" + fieldConfig.height;
            }
    ...
    var _FormElementFactory = {
        ...
        createInputRow: function(param) {
			...
			var labelHtml ="<div class='col-sm-3'>"
			labelHtml += "<" + AForm.Config.tags.label + " class='json-field-label form-label" +
            ...
            //LTX
            if (param.fieldConfig.height) {
                cssText += ";height:" + param.fieldConfig.height;
            }
